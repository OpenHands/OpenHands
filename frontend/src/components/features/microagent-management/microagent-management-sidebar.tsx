...
export function MicroagentManagementSidebar({
  ...
  return (
    <div
      className={cn(
        "w-[418px] h-full max-h-full overflow-y-auto overflow-x-hidden border-r border-[var(--color-border)] bg-[#24272E] rounded-tl-lg rounded-bl-lg py-10 px-6 flex flex-col custom-scrollbar-always",
      ...
      <div className="flex flex-col gap-2 w-full mt-6">
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              "bg-tertiary border border-[#717888] bg-[var(--color-tertiary)] w-full rounded-sm p-2 placeholder:text-tertiary-alt",
