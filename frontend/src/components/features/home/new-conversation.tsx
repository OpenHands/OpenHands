...
export function NewConversation() {
  ...
  return (
    <section className="w-full min-h-[286px] md:min-h-auto flex flex-col rounded-[12px] p-[20px] gap-[10px] border border-[var(--color-border-strong)] bg-[var(--color-surface-alt)] relative">
