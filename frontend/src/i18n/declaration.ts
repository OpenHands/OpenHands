...
export enum I18nKey {
  ...
  CONVERSATION$MCP_UNAVAILABLE_SINGLE = "CONVERSATION$MCP_UNAVAILABLE_SINGLE",
  CONVERSATION$MCP_UNAVAILABLE_MULTIPLE = "CONVERSATION$MCP_UNAVAILABLE_MULTIPLE",
  CONVERSATION$MCP_UNAVAILABLE_SERVER_LINE = "CONVERSATION$MCP_UNAVAILABLE_SERVER_LINE",
  CONVERSATION$MCP_UNAVAILABLE_SETTINGS_LINK = "CONVERSATION$MCP_UNAVAILABLE_SETTINGS_LINK",
  ...
  SETTINGS$MCP_HEALTH_STATUS = "SETTINGS$MCP_HEALTH_STATUS",
  SETTINGS$MCP_LAST_TESTED = "SETTINGS$MCP_LAST_TESTED",
  SETTINGS$MCP_TEST_CONNECTION = "SETTINGS$MCP_TEST_CONNECTION",
  SETTINGS$MCP_HEALTH_TESTING = "SETTINGS$MCP_HEALTH_TESTING",
  SETTINGS$MCP_HEALTH_HEALTHY = "SETTINGS$MCP_HEALTH_HEALTHY",
  SETTINGS$MCP_HEALTH_UNHEALTHY = "SETTINGS$MCP_HEALTH_UNHEALTHY",
  SETTINGS$MCP_HEALTH_UNKNOWN = "SETTINGS$MCP_HEALTH_UNKNOWN",
  SETTINGS$MCP_SERVER_SAVED = "SETTINGS$MCP_SERVER_SAVED",
  SETTINGS$MCP_SERVER_DELETED = "SETTINGS$MCP_SERVER_DELETED",
  SETTINGS$MCP_FAILURE_CONFIGURATION = "SETTINGS$MCP_FAILURE_CONFIGURATION",
  SETTINGS$MCP_FAILURE_CONNECTION = "SETTINGS$MCP_FAILURE_CONNECTION",
  SETTINGS$MCP_FAILURE_AUTHENTICATION = "SETTINGS$MCP_FAILURE_AUTHENTICATION",
  SETTINGS$MCP_FAILURE_PROTOCOL = "SETTINGS$MCP_FAILURE_PROTOCOL",
  SETTINGS$MCP_FAILURE_TOOL_DISCOVERY = "SETTINGS$MCP_FAILURE_TOOL_DISCOVERY",
  SETTINGS$MCP_FAILURE_EXECUTION = "SETTINGS$MCP_FAILURE_EXECUTION",
  SETTINGS$MCP_FAILURE_SANDBOX = "SETTINGS$MCP_FAILURE_SANDBOX",
  SETTINGS$MCP_FAILURE_TIMEOUT = "SETTINGS$MCP_FAILURE_TIMEOUT",
  SETTINGS$MCP_FAILURE_INTERNAL = "SETTINGS$MCP_FAILURE_INTERNAL",
