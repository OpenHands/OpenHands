...
export enum I18nKey {
  ...
  SLASH_COMMANDS$CLEAR_DESCRIPTION = "SLASH_COMMANDS$CLEAR_DESCRIPTION",
  SLASH_COMMANDS$SETTINGS_DESCRIPTION = "SLASH_COMMANDS$SETTINGS_DESCRIPTION",
  SLASH_COMMANDS$MODEL_DESCRIPTION = "SLASH_COMMANDS$MODEL_DESCRIPTION",
  SLASH_COMMANDS$CLEAR_CONFIRM = "SLASH_COMMANDS$CLEAR_CONFIRM",
}
