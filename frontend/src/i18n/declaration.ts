...
export enum I18nKey {
  ...
  CONVERSATION$MADE_PUBLIC = "CONVERSATION$MADE_PUBLIC",
  CONVERSATION$MADE_PRIVATE = "CONVERSATION$MADE_PRIVATE",
  CONVERSATION$UPDATE_PUBLIC_ERROR = "CONVERSATION$UPDATE_PUBLIC_ERROR",
  ...
  CONVERSATION$PRIVATE_OR_NOT_EXIST = "CONVERSATION$PRIVATE_OR_NOT_EXIST",
  CONVERSATION$PUBLIC_READ_ONLY = "CONVERSATION$PUBLIC_READ_ONLY",
}
