...
export enum I18nKey {
  ...
  SETTINGS$LLM_PROVIDER_OPENAI_LABEL = "SETTINGS$LLM_PROVIDER_OPENAI_LABEL",
  SETTINGS$SIGN_IN_WITH_CHATGPT = "SETTINGS$SIGN_IN_WITH_CHATGPT",
  SETTINGS$SIGNED_IN_WITH_CHATGPT = "SETTINGS$SIGNED_IN_WITH_CHATGPT",
  SETTINGS$SIGN_OUT_CHATGPT = "SETTINGS$SIGN_OUT_CHATGPT",
  SETTINGS$CHATGPT_TOS_LINK = "SETTINGS$CHATGPT_TOS_LINK",
  SETTINGS$CHATGPT_DEVICE_INSTRUCTIONS = "SETTINGS$CHATGPT_DEVICE_INSTRUCTIONS",
