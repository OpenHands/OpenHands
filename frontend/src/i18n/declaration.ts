...
export enum I18nKey {
  ...
  SETTINGS$SANDBOX_GPU_RUNTIME = "SETTINGS$SANDBOX_GPU_RUNTIME",
  SETTINGS$SANDBOX_GPU_RUNTIME_DESCRIPTION = "SETTINGS$SANDBOX_GPU_RUNTIME_DESCRIPTION",
  SETTINGS$SANDBOX_ENABLE_GPU = "SETTINGS$SANDBOX_ENABLE_GPU",
  SETTINGS$SANDBOX_GPU_CUDA_IMAGE = "SETTINGS$SANDBOX_GPU_CUDA_IMAGE",
  ...
  SYSTEM_MESSAGE_MODAL$SEARCH_TOOLS_PLACEHOLDER = "SYSTEM_MESSAGE_MODAL$SEARCH_TOOLS_PLACEHOLDER",
  SYSTEM_MESSAGE_MODAL$EXPAND_ALL = "SYSTEM_MESSAGE_MODAL$EXPAND_ALL",
  SYSTEM_MESSAGE_MODAL$COLLAPSE_ALL = "SYSTEM_MESSAGE_MODAL$COLLAPSE_ALL",
  ...
  SKILLS_MODAL$SEARCH_PLACEHOLDER = "SKILLS_MODAL$SEARCH_PLACEHOLDER",
  SKILLS_MODAL$EXPAND_ALL = "SKILLS_MODAL$EXPAND_ALL",
  SKILLS_MODAL$COLLAPSE_ALL = "SKILLS_MODAL$COLLAPSE_ALL",
  ...
  HOOKS_MODAL$SEARCH_PLACEHOLDER = "HOOKS_MODAL$SEARCH_PLACEHOLDER",
  HOOKS_MODAL$EXPAND_ALL = "HOOKS_MODAL$EXPAND_ALL",
  HOOKS_MODAL$COLLAPSE_ALL = "HOOKS_MODAL$COLLAPSE_ALL",
