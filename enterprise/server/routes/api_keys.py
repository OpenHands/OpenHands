...
@api_router.get('/llm/byor/permitted', tags=['Auth'])
...
@api_router.delete('/{key_id}', tags=['Auth'])
...
@api_router.get('/llm/byor', tags=['Auth'])
...
@api_router.post('/llm/byor/refresh', tags=['Auth'])
