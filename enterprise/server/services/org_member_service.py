...
class OrgMemberService:
    ...
    async def get_me(org_id: UUID, user_id: UUID) -> MeResponse:
        ...
        org_member = await OrgMemberStore.get_org_member_async(org_id, user_id)
    ...
    async def remove_org_member(
        ...
        requester_membership = await OrgMemberStore.get_org_member_async(
        ...
        target_membership = await OrgMemberStore.get_org_member_async(
        ...
        if target_role.name == ROLE_OWNER:
            if await OrgMemberService._is_last_owner_async(org_id, target_user_id):
    ...
    async def update_org_member(
        ...
        if (
            ...
            and await OrgMemberService._is_last_owner_async(org_id, target_user_id)
        ):
    ...
    @staticmethod
    async def _is_last_owner_async(org_id: UUID, user_id: UUID) -> bool:
