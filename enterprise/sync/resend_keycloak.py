...
class RateLimiter:
    ...
    This class ensures that API calls do not exceed a specified rate limit
    by tracking the time of the last call and waiting if necessary before
    allowing the next call.
    """
    ...
    def __init__(self, requests_per_second: float, safety_margin: float = 0.1):
        ...
        Args:
            ...
            safety_margin: Fraction of additional wait time to add as buffer (0.1 = 10%).
        """
    ...
    def wait(self) -> None:
        ...
        to ensure we stay within the rate limit.
        """
        with self._lock:
        ...
        while offset < total_users:
            ...
            for user in users:
                ...
                try:
                    ...
                    # Rate limiting is handled by resend_rate_limiter in add_contact_to_resend
                    ...
                    # Rate limiting is handled by resend_rate_limiter in send_welcome_email
                    try:
