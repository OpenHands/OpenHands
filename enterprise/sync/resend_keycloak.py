...
# Safety margin to prevent hitting rate limits (10% buffer)
...
class RateLimiter:
    ...
    Ensures that API calls are spaced out to respect rate limits across all
    operations, not just within individual functions.
    """
    ...
    def __init__(self, requests_per_second: float, safety_margin: float = 0.9):
        ...
        Args:
            ...
            safety_margin: Safety margin to apply (0.9 = 90% of limit).
        """
...
resend_rate_limiter = RateLimiter(RATE_LIMIT, RATE_LIMIT_SAFETY_MARGIN)
