...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'AUTOMATIONS$EXPERIMENT$PLUGIN_SOURCE_PLACEHOLDER',
  'AUTOMATIONS$EXPERIMENT$SCHEDULE_PLACEHOLDER',
  'AUTOMATIONS$GIT_SYNC$BRANCH_PLACEHOLDER',
  'AUTOMATIONS$GIT_SYNC$PATH_PLACEHOLDER',
  'AUTOMATIONS$GIT_SYNC$REPO_URL_PLACEHOLDER',
  'AUTOMATIONS$WEBHOOKS$EVENT_KEY_EXPR_PLACEHOLDER',
  'AUTOMATIONS$WEBHOOKS$SIGNATURE_HEADER_PLACEHOLDER',
  'BACKEND$CLOUD_TITLE',
