...
async def require_confirmation(
    ...
    *,
    ...
    """
    mode: AutonomyMode
    if autonomy_mode in ("manual", "semi_autonomous", "autonomous"):
        mode = autonomy_mode  # type: ignore[assignment]
    else:
    ...
    # Also accept env token matching a previously issued pending token
    import os
