...
- For V1 web-app docs, LLM setup should point users to the Settings UI. `make setup-config` is mainly for headless/CLI workflows, not the primary web-app LLM path.
- Testing:
