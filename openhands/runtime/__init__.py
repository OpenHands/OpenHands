"""OpenHands Runtime - Runtime implementations for agent execution environments.

.. deprecated:: 1.0.0
    This package is deprecated and will be removed on April 1, 2025.
    Please migrate to the OpenHands SDK: https://github.com/All-Hands-AI/openhands-sdk

    The V1 API in the SDK provides equivalent functionality with a redesigned
    architecture. While it does some things differently, it can do everything
