...
"""
    ...
    def get_microagents_from_org_or_user(
        ...
        # Default for GitHub/GitLab/Bitbucket format: owner/repo (2 parts) - extract owner
        org_name = repo_parts[-2]  # Get owner from owner/repo

        # Override for Azure DevOps format: org/project/repo (3 parts) - extract org (first part)
