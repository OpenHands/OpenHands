  ...
  const handleSave = useCallback(async () => {
    ...
    if (authType === LLM_AUTH_TYPE_SUBSCRIPTION) {
      ...
      if (isCloudOpenHandsProvider) {
        ...
        // The Basic tab does not render base_url directly. Drop a stale hidden
        // URL when switching ordinary providers, but retain SSYCloud's preset
        // URL: its runtime model uses the generic `openai/` compatibility
