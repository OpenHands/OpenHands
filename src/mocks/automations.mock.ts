 ...
 * tarball_path, setup_script_path, entrypoint, timeout, keep_alive,
 * preset_metadata, enabled, last_triggered_at, created_at, updated_at.
 *
  ...
  automations: [
    {
      ...
      preset_metadata: {
        repos: [
          ...
          { url: "https://github.com/acme/design-system", provider: "github" },
        ],
      },
