  ...
  automations: [
    {
      ...
      notification: "Email digest to eng-reviews",
    ...
    },
    {
      ...
      branch: "main",
      plugins: ["GitHub"],
      notification: "Email to docs-updates",
    ...
    },
    {
      ...
      branch: "release",
      plugins: ["GitHub", "Linear"],
      notification: "Email to releases",
    ...
    },
    {
      ...
      updated_at: now,
      prompt:
        "Summarize incoming incident webhooks, categorize by severity, and post a digest to the on-call channel.",
      branch: "main",
      plugins: ["Email"],
      notification: "Email to oncall",
      timezone: "UTC",
