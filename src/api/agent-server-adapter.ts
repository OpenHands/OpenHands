...
} from "./conversation-service/conversation-tag-keys";

// Serialization and the wire tag keys moved to dedicated modules behind this
// facade. Re-exported so existing importers keep working while callers migrate
// to the narrower entry points.
export {
  ACP_SERVER_TAG_KEY,
...
export {
  ...
  toAppConversation,
  toConversationPage,
} from "./conversation-service/conversation-serializer";
export type { DirectConversationInfo } from "./conversation-service/conversation-serializer";
