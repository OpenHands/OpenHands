...
describe("AgentServerUIProviders", () => {
  ...
  it("portals simultaneous modals into isolated body-level hosts", async () => {
    ...
    expect(lightHost).toHaveAttribute("data-color-theme");
    expect(lightHost).toHaveAttribute("data-color-scheme", "light");
    ...
    expect(darkHost).toHaveAttribute("data-color-theme");
    expect(darkHost).toHaveAttribute("data-color-scheme", "dark");
