...
name: e2e-testing
description: >
  End-to-end testing frameworks for agent-canvas — the live framework, the
  mock-LLM framework, shared Docker image specs, and the failure-debugging
  workflow (CI artifacts, error-context snapshots, common patterns). Load
  before writing or debugging E2E specs.
triggers:
  - e2e
  - end-to-end
  - mock-llm
